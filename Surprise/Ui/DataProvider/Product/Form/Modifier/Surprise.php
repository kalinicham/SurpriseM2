 ...
 * @since 101.0.0
 */
class Surprise extends AbstractModifier
{
    const DATA_SCOPE = '';
...
//    const GROUP_SURPRISE = 'related';
    ...
    public function modifyMeta(array $meta)
    {
        $meta = array_replace_recursive(
            $meta,
            [
                static::GROUP_SURPRISE => [
                    'children' => [
                        $this->scopePrefix . static::DATA_SCOPE_SURPISE => $this->getRelatedFieldset(),
                    ],
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Surprise product'),
                                'collapsible' => true,
        ...
        return [
            'children' => [
                'button_set' => $this->getButtonSet(
                    $content,
                    __('Add Surprise Products'),
                    $this->scopePrefix . static::DATA_SCOPE_SURPISE
                ),
                'modal' => $this->getGenericModal(
                    __('Add Surprise Products'),
                    $this->scopePrefix . static::DATA_SCOPE_SURPISE
                ),
                static::DATA_SCOPE_SURPISE => $this->getGrid($this->scopePrefix . static::DATA_SCOPE_SURPISE),
            ],
            'arguments' => [
                'data' => [
                    'config' => [
                        'additionalClasses' => 'admin__fieldset-section',
                        'label' => __('Surprise Products'),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => 10,
    ...
    {
        $modalTarget = $this->scopeName . '.' . static::GROUP_SURPRISE . '.' . $scope . '.modal';
